...
diracx:
  settings:
    ...
    DIRACX_SANDBOX_STORE_S3_CLIENT_KWARGS: '{"endpoint_url": "http://seaweedfs.invalid:8333", "aws_access_key_id": "my-access-key", "aws_secret_access_key": "my-secret-key-123"}'
